# -*- coding: utf-8 -*-
#
# django-selector documentation build configuration file, created by
...
htmlhelp_basename = 'django-selectordoc'
...
latex_documents = [
  ('index', 'django-selector.tex', u'django-selector Documentation',
